...
def get_model_input(dp):
    article = dp["article"]
    summary = dp["question"]
    return f"{prompt_text} \nArticle: {article} \nSummary: {summary} \n@placeholder options {get_text_with_option_words(dp, include_option5=True)} \n Answer: "
...
if __name__ == "__main__":
    negative_augmented_data_folder = "./data/dataset/NAL/"
    output_folder = "./data/dataset/training_format/NAL/"
